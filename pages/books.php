...
<html>
	<head>
		<title>Libreria Ad Astra - Libri</title>
		 	...
		 	<div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link active" href="books.php">Libri</a>
						</li>
						<li class="nav-item">
  		...
  		<div class="container-fluid mt-3">
	        <div class="row">
        		...
        		<div class="col-md-2" style="">
      				...
      				<!-- Search bar -->
					<input type="search" id="search-bar" class="form-control mb-3" aria-label="Search" placeholder="Cerca" oninput="loadBooks();">

					<!-- Number of books to be shown -->
					<select id="num-books" class="form-select" aria-label="select" onchange="loadBooks();">
						<option value="20" selected disabled>Numero di libri da mostrare</option>
	            ...
	            <div class="col-md-10 mt-4 mt-md-0">
	            	<div class="container-fluid">
						<div class="row">
							...
							<!-- Element in which books are loaded and shown -->
							<div id="book-page-content" class="card-group"></div>
